...
import com.coderpage.weather.MApplication;
...
//        AllCity.initCityWeather();
        ...
        locationClient = ((MApplication) getApplication()).locationClient;
        initLocation();
    ...
    private void intiView() {
        ...
        titileLocationIV = (ImageView) findViewById(R.id.title_bar_location);
